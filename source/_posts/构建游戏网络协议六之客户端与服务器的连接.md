...
[![](http://blog.sensedevil.com/image/client-time.png)](http://blog.sensedevil.com/image/client-time.png)
...
[![](http://blog.sensedevil.com/image/connection-request.png)](http://blog.sensedevil.com/image/connection-request.png)

When a client requests a connection, it gets assigned to one of these slots:

[![](http://blog.sensedevil.com/image/connection-accepted.png)](http://blog.sensedevil.com/image/connection-accepted.png)

If a client requests connection, but no slots are available, the server is full and the connection request is denied:

[![](http://blog.sensedevil.com/image/server-is-full.png)](http://blog.sensedevil.com/image/server-is-full.png)
...
[![](http://blog.sensedevil.com/image/client-server-packets.png)](http://blog.sensedevil.com/image/client-server-packets.png)
...
[![](http://blog.sensedevil.com/image/connection-request-packet.png)](http://blog.sensedevil.com/image/connection-request-packet.png)
...
[![](http://blog.sensedevil.com/image/connection-accepted-packet.png)](http://blog.sensedevil.com/image/connection-accepted-packet.png)
...
[![](http://blog.sensedevil.com/image/challenge-response.png)](http://blog.sensedevil.com/image/challenge-response.png)
...
[![](http://blog.sensedevil.com/image/connection-request-packet-2.0.png)](http://blog.sensedevil.com/image/connection-request-packet-2.0.png)
...
[![](http://blog.sensedevil.com/image/challenge-packet.png)](http://blog.sensedevil.com/image/challenge-packet.png)
...
[![](http://blog.sensedevil.com/image/challenge-response-packet.png)](http://blog.sensedevil.com/image/challenge-response-packet.png)
...
[![](http://blog.sensedevil.com/image/connection-payload-packet.png)](http://blog.sensedevil.com/image/connection-payload-packet.png)
...
[![](http://blog.sensedevil.com/image/disconnect-packet.png)](http://blog.sensedevil.com/image/disconnect-packet.png)
